...
// import { restaurantData } from "../restaurentData";
  ...
  {loading && <>
      ...
      <div className="btnSection">
        ...
        {/* {restaurantData.map((restaurant, index) => (
            <div key={index} className="restaurantBox">
                <img src={restaurant.item_img} alt={`Restaurant ${index + 1}`} className="restaurantImg" />
            </div>
        ))} */}
